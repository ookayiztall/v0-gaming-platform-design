...
export default function ResetPasswordForm() {
  ...
  if (!isValidToken) {
    return (
      <div className="container mx-auto py-8 px-4 flex items-center justify-center min-h-screen">
        <Card className="border-destructive/30 bg-card/50 backdrop-blur-sm w-full max-w-md">
          <CardHeader>
  ...
  return (
    <div className="container mx-auto py-8 px-4 flex items-center justify-center min-h-screen">
      <Card className="border-primary/30 bg-card/50 backdrop-blur-sm w-full max-w-md">
        <CardHeader>
